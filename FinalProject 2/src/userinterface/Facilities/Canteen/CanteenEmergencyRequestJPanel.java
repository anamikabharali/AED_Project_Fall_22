...
public class CanteenEmergencyRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 177, -1, -1));

        locationlbl.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        locationlbl.setText("Location");
        add(locationlbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 308, -1, -1));
        ...
        add(sendemergency, new org.netbeans.lib.awtextra.AbsoluteConstraints(283, 439, -1, -1));

        combo.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        combo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(combo, new org.netbeans.lib.awtextra.AbsoluteConstraints(504, 174, 99, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 568, -1, -1));

        locationfiield.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        add(locationfiield, new org.netbeans.lib.awtextra.AbsoluteConstraints(504, 302, 99, -1));
