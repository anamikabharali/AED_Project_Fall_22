...
public class FacilitiesAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Facilities Admin Page");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(245, 80, 250, -1));
        ...
        add(userJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 360, 150, 60));
        ...
        add(manageEmployeeJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 360, 150, 60));
        ...
        add(manageOrganizationJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 360, -1, 60));

        enterpriseLabel.setFont(new java.awt.Font("Optima", 0, 14)); // NOI18N
        enterpriseLabel.setForeground(new java.awt.Color(255, 255, 255));
        enterpriseLabel.setText("EnterPrise :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 100, 30));

        valueLabel.setFont(new java.awt.Font("Optima", 0, 13)); // NOI18N
        valueLabel.setForeground(new java.awt.Color(255, 255, 255));
        valueLabel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 250, 170, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon("/Users/anamikabharali/Documents/GitHub/AED_Project_Fall_22/header photo.jpg")); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 770, 170));
