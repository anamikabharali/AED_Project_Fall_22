...
public class MiscellaneousComplaintJPanel extends javax.swing.JPanel {
 ...
 Complaints_Suggestions_Request request = new Complaints_Suggestions_Request();
    ...
    private void initComponents() {
        ...
        add(messageJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 260, 270, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 483, 110, 30));
        ...
        add(sendComplaint, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 390, 210, 30));

        combo.setFont(new java.awt.Font("Optima", 0, 14)); // NOI18N
        combo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(combo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 270, -1));

        jLabel3.setFont(new java.awt.Font("Optima", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Department :");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 318, -1, 30));

        jLabel1.setFont(new java.awt.Font("Optima", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Message :");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 258, -1, 30));

        jLabel2.setFont(new java.awt.Font("Optima", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("MISCELLANEOUS COMPLAINTS REGISTRATION");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, -1, 50));
